...
namespace BusinessLibrary.Models
{
    class Instructor
    {
        ...
        /// Fields constructor.
        /// </summary>
        public Instructor(string id, string firstName, string lastName, string trainingType, string trainingPhilosophy, string exerciseModality, int clientPopulation, string accreditation)
        {
            Id = id;
            FirstName = firstName;
            LastName = lastName;
        ...
        public Instructor(Instructor instance)
            : this(instance.Id, instance.FirstName, instance.LastName, instance.TrainingType, instance.TrainingPhilosophy, instance.ExerciseModality, instance.ClientPopulation, instance.Accreditation)
        {
        }
